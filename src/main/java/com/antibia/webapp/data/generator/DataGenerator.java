package com.antibia.webapp.data.generator;

import com.antibia.webapp.data.entity.SamplePerson;
import com.antibia.webapp.data.service.SamplePersonRepository;
    ...
    public CommandLineRunner loadData(SamplePersonRepository samplePersonRepository) {
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2022, 1, 7, 0, 0, 0));
